...
public class ActionLogService {
    ...
    public UserDTO.ResActionLogs getActionLogs(Long userId, UserDTO.ReqActionLogs reqActionLogs) {
        Page<ActionLog> actionLogsPage = actionLogRepository.findAllByUserIdOrderByRegDtmDesc(userId, new PageRequest(reqActionLogs.getPageNo(), reqActionLogs.getPageSize()));
