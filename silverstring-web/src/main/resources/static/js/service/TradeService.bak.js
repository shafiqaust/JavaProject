var TradeService = /** @class */ (function () {
    ...
    TradeService.prototype.determine = function (type, percent) {
        ...
        if (type == "buy") {
            ...
            fee = (balance * (formData.tradingFeePercent / 100).toFixed(8)).toFixed(8);
        } else {
            balance = amount;
            fee = ((price * amount) * (formData.tradingFeePercent / 100).toFixed(8)).toFixed(8);
        }
        ...
        if (type == "buy") {
            ...
            totalBalance = ((price * amount) - parseFloat(fee)).toFixed(8);
        }
